    ...
    <div className="max-w-4xl mx-auto py-8 lg:py-16 animate-in fade-in duration-500 space-y-16">
      ...
      <div className="text-center relative">
        ...
        <p className="text-xl md:text-2xl text-stone-700 font-medium max-w-2xl mx-auto px-4 leading-relaxed">
          A practical, community-driven resource to help us all discover and manage native ecosystems.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
        ...
        <div className="bg-[#BFDBFE] border-4 border-stone-900 shadow-[6px_6px_0_0_rgba(28,25,23,1)] p-8 md:p-10 relative">
      ...
      <div className="bg-white border-4 border-stone-900 p-8 md:p-12 text-center shadow-[6px_6px_0_0_rgba(28,25,23,1)] relative overflow-hidden">
